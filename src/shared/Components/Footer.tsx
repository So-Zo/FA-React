      ...
      <div className="footer-content">
        <div className="footer-branding">
          ...
          <p className="footer-tagline">
            FanArcs is your go-to platform for exploring and sharing content
            across anime, manga, comics, TV, and more. Join our community of
            passionate fans!
          </p>
        ...
        <div className="footer-contact">
          <h3>Contact Us</h3>
          <p>
            <span aria-hidden="true">📧</span> contact@fanarcs.com
          </p>
          <p>
            <span aria-hidden="true">📱</span> (555) 123-4567
          </p>
          <p>
            <span aria-hidden="true">🏢</span> 123 Fan Street, Anime City
          </p>
        </div>
      </div>
