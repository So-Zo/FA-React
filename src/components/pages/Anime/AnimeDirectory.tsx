      ...
      <div className="profile-card-grid">
        <div className="profile-card">
         ...
         <div className='profile-card-content'>
          <h3>Naruto</h3>
            ...
            <p >Follow Naruto Uzumaki, a young ninja who seeks recognition from his peers and dreams of becoming the Hokage, the leader of his village.</p>
            <div className="show-links">
              <Link to ="/characters" className='default-links' aria-label='go to Naruto page'> Naruto Page </Link>
            </div>
          </div>
        </div>
        <div className="profile-card">
        ...
        <div className="profile-card">
          ...
          <h3>My Hero Academia</h3>
            ...
            <p >In a world where people with superpowers known as "Quirks" are the norm, Izuku Midoriya has dreams of becoming a hero despite being born without abilities.</p>
            <div className="show-links">
        ...
        <div className="profile-card">
          ...
          <h3>Demon Slayer</h3>
            ...
            <p >Tanjiro Kamado's peaceful life is shattered after his family is slaughtered by a demon. Now, he fights demons while searching for a cure for his sister, who has been turned into a demon.</p>
            <div className="show-links">
