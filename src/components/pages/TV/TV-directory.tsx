  ...
  return (
    <div className="tv-page tv-directory-page">
      ...
      <TableOfContents
        ...
        title="TV Directory"
        description="Use this table of contents to navigate to different sections of the TV Directory."
      />
      ...
      <main id="main-content" role="main">
          ...
          <div className="profile-card-grid">
            <div className="profile-card">
              <div className="profile-card-image">
                <img
                  src="/images/tv/shows/breaking-bad.jpg"
                  alt="Breaking Bad"
                />
              </div>
              <div className="profile-card-content">
                ...
                <p>
                  Follow Walter White, a chemistry teacher turned
                  methamphetamine manufacturer, as he transforms from a
                  mild-mannered family man into a ruthless player in the drug
                  trade.
                </p>
                <div className="show-links">
                  ...
                  <a
                    ...
                    data-page-title="Walter White"
                    data-related-to="Breaking Bad"
                  >
            ...
            <div className="profile-card">
              <div className="profile-card-image">
                <img
                  src="/images/tv/shows/game-of-thrones.jpg"
                  alt="Game of Thrones"
                />
              </div>
              <div className="profile-card-content">
                ...
                <p>
                  ...
                  families fight for control of the Seven Kingdoms and the Iron
                  Throne, while ancient threats emerge from beyond the Wall.
                </p>
                <div className="show-links">
                  <a
                    href="#"
                    className="non-existent-link"
                    data-page-type="show"
                    data-page-title="Game of Thrones"
                    data-related-to="TV"
                  >
                    Official Page
                  </a>
                  ...
                  <a
                    ...
                    className="non-existent-link"
                    data-page-type="character"
                    data-page-title="Jon Snow"
                    data-related-to="Game of Thrones"
                  >
                    Character: Jon Snow
                  </a>
                </div>
            ...
            <div className="profile-card">
              <div className="profile-card-image">
                <img
                  src="/images/tv/shows/stranger-things.jpg"
                  alt="Stranger Things"
                />
              </div>
              <div className="profile-card-content">
                ...
                <div className="show-links">
                  <a
                    ...
                    className="non-existent-link"
                    data-page-type="show"
                    data-page-title="Stranger Things"
                    data-related-to="TV"
                  >
                    Official Page
                  </a>
                  ...
                  <a
                    ...
                    className="non-existent-link"
                    data-page-type="character"
                    data-page-title="Eleven"
                    data-related-to="Stranger Things"
                  >
                    Character: Eleven
                  </a>
                </div>
              ...
              <div className="profile-card-content">
                ...
                <div className="show-links">
                  ...
                  <a
                    ...
                    className="non-existent-link"
                    data-page-type="character"
                    data-page-title="Michael Scott"
                    data-related-to="The Office"
                  >
        ...
        <section id="genres" className="section-content">
          ...
          <p>
            Find TV series based on your preferred storytelling styles and
            themes.
          </p>
          ...
          <ul className="show-list">
            ...
            <li>
              <a
                ...
                className="non-existent-link"
                data-page-type="show"
                data-page-title="Better Call Saul"
                data-related-to="TV"
              >
                Better Call Saul
              </a>
          ...
          <ul className="show-list">
            ...
            <li>
              <a
                ...
                className="non-existent-link"
                data-page-type="show"
                data-page-title="The Mandalorian"
                data-related-to="TV"
              >
                The Mandalorian
              </a>
          ...
          <ul className="show-list">
            ...
            <li>
              <a
                ...
                className="non-existent-link"
                data-page-type="show"
                data-page-title="Brooklyn Nine-Nine"
                data-related-to="TV"
              >
                Brooklyn Nine-Nine
              </a>
            ...
            <li>
              <a
                ...
                className="non-existent-link"
                data-page-type="show"
                data-page-title="Parks and Recreation"
                data-related-to="TV"
              >
          ...
          <ul className="show-list">
            <li>
              <a
                ...
                className="non-existent-link"
                data-page-type="show"
                data-page-title="True Detective"
                data-related-to="TV"
              >
                True Detective
              </a>
        ...
        <section id="eras" className="section-content">
          <h2>Browse by Era</h2>
          <p>
            Explore TV from different time periods, from classics to the latest
            releases. For a comprehensive overview of how television has evolved
        ...
        <section id="studios" className="section-content">
          ...
          <p>
            Discover TV shows produced by renowned networks known for their
              ...
              <ul className="show-list">
                ...
                <li>
                  <a
                    ...
                    className="non-existent-link"
                    data-page-type="directory"
                    data-page-title="Netflix Works"
                    data-related-to="TV"
                  >
                    View All Netflix Works
                  </a>
                </li>
              </ul>
            </div>
              ...
              <ul className="show-list">
                ...
                <li>
                  <a
                    ...
                    className="non-existent-link"
                    data-page-type="show"
                    data-page-title="The Walking Dead"
                    data-related-to="AMC"
                  >
                    The Walking Dead
                  </a>
              ...
              <ul className="show-list">
                ...
                <li>
                  <a
                    ...
                    className="non-existent-link"
                    data-page-type="show"
                    data-page-title="Peaky Blinders"
                    data-related-to="BBC"
                  >
                    Peaky Blinders
                  </a>
              ...
              <ul className="show-list-alpha">
                ...
                <li>
                  <a
                    ...
                    className="non-existent-link"
                    data-page-type="show"
                    data-page-title="Arrested Development"
                    data-related-to="TV"
                  >
                ...
                <li>
                  <a
                    ...
                    className="non-existent-link"
                    data-page-type="show"
                    data-page-title="American Horror Story"
                    data-related-to="TV"
                  >
