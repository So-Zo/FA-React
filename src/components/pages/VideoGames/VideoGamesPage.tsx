          ...
          <div className="profile-card-grid">
            <div className="profile-card">
              <div className="profile-card-content">
                ...
                <p className="profile-card-text">Often called the "Father of Video Games," Baer invented the first home video game console, the Magnavox Odyssey, released in 1972.</p>
              </div>
            </div>
            <div className="profile-card">
              <div className="profile-card-content">
                <h4 className="profile-card-title">Shigeru Miyamoto (1952-)</h4>
                <p className="profile-card-text">Nintendo's legendary designer who created iconic franchises including Mario, The Legend of Zelda, and Donkey Kong, revolutionizing game design principles.</p>
              </div>
            </div>
            <div className="profile-card">
              <div className="profile-card-content">
                <h4 className="profile-card-title">Roberta Williams (1953-)</h4>
                <p className="profile-card-text">Pioneer of graphic adventure games who co-founded Sierra On-Line and created the King's Quest series, helping establish narrative-driven gaming.</p>
              </div>
            </div>
          </div>
