    ...
    <section className="section-content" id="timeline-breakdown">
      <h2>Timeline Breakdown</h2>
            ...
            <p>
              ...
              prints of the Edo period (1603-1867) established many visual conventions later adopted by manga, including bold outlines,
              flat perspectives, and expressive faces.
            </p>
            <p>
              Hokusai, the renowned ukiyo-e artist, first used the term "manga" (meaning "whimsical pictures") for his sketchbooks published
              between 1814 and 1878. These weren't sequential narratives but collections of sketches showing everyday life, supernatural
            ...
            <p>
              ...
              (1923) featured manga stories aimed at specific gender demographics, establishing a publishing model that continues today.
            </p>
            <p>
              Western comics and animation, particularly Disney, influenced Japanese artists during this period. The four-panel comic
            ...
            <p>
              ...
              "New Treasure Island" (1947) revolutionized manga with cinematic techniques inspired by Disney and French films, using
              dynamic panel layouts and "camera movements" to create a more immersive reading experience.
            </p>
            <p>
              Tezuka's prolific output included "Astro Boy" (1952), "Princess Knight" (1953), and "Kimba the White Lion" (1950), establishing
              many conventions of modern manga. His work demonstrated manga's potential to tell sophisticated, long-form stories across
              genres. The distinctive large eyes that became characteristic of manga were partly inspired by Disney animation and partly
              developed to enhance emotional expressiveness.
            </p>
            <p>
              This period also saw the emergence of rental manga (kashihon manga), inexpensive books rented from shops that allowed
            ...
            <p>
              ...
              adventure series. Shōjo (girls') manga evolved dramatically as female creators like Moto Hagio and Keiko Takemiya formed
              the "Year 24 Group" (named for their birth year, Showa 24 or 1949), bringing psychological depth, gender exploration,
              and innovative visual techniques to girls' comics.
            </p>
            <p>
              Manga for adult readers expanded with seinen (men's) and josei (women's) magazines. Influential works of this era include
              "Ashita no Joe" (Tomorrow's Joe), a boxing drama addressing social inequality; "Lone Wolf and Cub," a historical samurai
              epic; and "The Rose of Versailles," a shōjo classic set during the French Revolution. The alternative manga movement
              produced experimental works in magazines like "Garo," which emphasized artistic expression and social commentary.
            </p>
            <p>
              This period also saw the rise of genres that would become iconic in manga: giant robot/mecha series, magical girls,
            ...
            <p>
              ...
              achieved massive popularity. Katsuhiro Otomo's cyberpunk epic "Akira" (1982-1990) demonstrated manga's potential for
              sophisticated science fiction storytelling and was adapted into an influential animated film that helped introduce manga
              to Western audiences.
            </p>
            <p>
              The economic bubble of the 1980s fueled manga's expansion, with publishers investing in new magazines and formats. The
              tankōbon format (collected volumes) became the standard way to collect and preserve manga series, creating a substantial
              back-catalog market. Manga cafés where customers could read from extensive libraries became popular social spaces.
            </p>
            <p>
              Manga began to gain international recognition during this period. Translations appeared in Europe, particularly France,
              where Japanese comics were respected as "la nouvelle manga." In North America, companies like Viz Media and Dark Horse
            ...
            <p>
              ...
              methods remain in use. Digital distribution platforms and subscription services like Shueisha's Manga Plus offer simultaneous
              global release of new chapters, reducing the gap between Japanese and international readers.
            </p>
            <p>
              Manga has achieved unprecedented global popularity, becoming a major cultural export for Japan. Series like "Naruto," "One Piece,"
              and "Attack on Titan" have achieved massive international followings. The influence of manga aesthetics and storytelling
              approaches can be seen in comics worldwide, from American graphic novels to Korean manhwa and Chinese manhua.
            </p>
            <p>
              New publishing models have emerged, including webtoons (vertically-scrolling digital comics) and self-published doujinshi
              (fan comics) that can achieve commercial success. The boundaries between professional and amateur creation have blurred,
    ...
    <section className="section-content" id="key-figures">
      ...
      <div className="figure-cards">
        <div className="figure-card">
          ...
          <p>
            Often called the "God of Manga" and "Father of Manga," Tezuka revolutionized the medium with cinematic storytelling techniques
            and thematic depth. His prolific output (estimated at 150,000 pages and 700 manga series) spanned every genre from children's
            comics to adult drama. Key works include "Astro Boy," "Black Jack," "Phoenix," and "Buddha." Tezuka also pioneered anime
            production, establishing the relationship between manga and animation that continues today.
          </p>
        </div>
        ...
        <div className="figure-card">
          ...
          <p>
            Creator of "Sazae-san," one of Japan's most beloved and longest-running manga series (1946-1974). Hasegawa was one of the
            first successful female manga artists, and her domestic comedy about the Fuguta family became a cultural institution, later
            adapted into a TV anime that continues to air today. Her work captured the changing nature of Japanese family life during
            the post-war period.
          </p>
        </div>
        ...
        <div className="figure-card">
          ...
          <p>
            Pioneer of "gekiga" (dramatic pictures), a more realistic, adult-oriented style of manga that emerged in the late 1950s.
            Tatsumi's work addressed social issues, psychological struggles, and the darker aspects of urban life. His autobiography
            "A Drifting Life" chronicles the development of manga in post-war Japan. Tatsumi's emphasis on manga as a serious artistic
            medium influenced generations of creators.
          </p>
        </div>
        ...
        <div className="figure-card">
          ...
          <p>
            A cohort of female manga artists born around 1949 (Showa year 24) who revolutionized shōjo manga in the 1970s. Key members
            include Moto Hagio ("The Heart of Thomas"), Keiko Takemiya ("Kaze to Ki no Uta"), and Riyoko Ikeda ("The Rose of Versailles").
            They introduced psychological complexity, gender exploration, and innovative visual techniques to girls' comics, elevating
            shōjo manga to artistic prominence and expanding its thematic range.
          </p>
        </div>
        ...
        <div className="figure-card">
          ...
          <p>
            Creator of globally influential series including "Dr. Slump" and "Dragon Ball." Toriyama's distinctive art style, humor,
            and action sequences have influenced countless manga artists and global pop culture. "Dragon Ball" became one of the
            best-selling manga series of all time and helped define the battle shōnen genre. His character designs have also been
            featured in video games like the Dragon Quest series.
          </p>
        </div>
        ...
        <div className="figure-card">
          ...
          <p>
            Acclaimed creator of sophisticated thriller and mystery series including "Monster," "20th Century Boys," and "Pluto."
            Urasawa's work is known for complex plotting, psychological depth, and realistic art style. He has received numerous
            awards and critical recognition for elevating manga storytelling. His work demonstrates manga's capacity for literary
    ...
    <section className="section-content" id="influences-impact">
      ...
      <h3>What Influenced Manga</h3>
          ...
          <p>
            ...
            zenga (Zen Buddhist paintings). These influences can be seen in compositional techniques, line work, and visual
          ...
          <p>
            ...
            Osamu Tezuka openly acknowledged Disney's influence on his character designs and cinematic storytelling approach.
          ...
          <p>
            ...
            economic boom and bust cycles, and changing social values. The emphasis on hard work, perseverance, and self-improvement
          ...
          <p>
            ...
            model, demographic targeting (shōnen, shōjo, seinen, josei), editor-creator relationships, and the tankōbon collection
      ...
      <h3>Manga's Cultural Impact</h3>
          ...
          <p>
            ...
            communications. Characters from popular manga appear on everything from airplanes to public safety posters. Manga has
          ...
          <p>
            ...
            techniques have been adopted by comics creators worldwide. The success of manga has inspired similar industries in other
          ...
          <p>
            ...
            exhibitions, and academic institutions offer courses in manga studies. Award-winning works like Naoki Urasawa's "Monster"
    ...
    <section className="section-content" id="controversies-turning-points">
      <h2>Controversies & Turning Points</h2>
          ...
          <p>
            ...
            pushed boundaries with explicit content, leading to public debates. More recently, concerns about sexual content, particularly
            involving young-appearing characters, have led to regulatory efforts in Japan and import restrictions in some countries. The
          ...
          <p>
            ...
            struggled to adapt their business models, while new platforms have emerged. Piracy through scanlation (fan translation and
          ...
          <p>
            ...
            and ethnicity. Stereotypical portrayals of non-Japanese characters have drawn criticism. At the same time, manga has provided
          ...
          <p>
            ...
            weekly deadlines. Health issues among manga artists are common, with some creators hospitalized for exhaustion. The assistant
          ...
          <p>
            ...
            heavily modified content for Western audiences, while modern approaches tend to preserve more Japanese elements. The growth of
            simulpublication (simultaneous global release) has raised questions about whether creators are now considering international
    ...
    <section className="section-content" id="further-reading">
      <h2>Further Reading & Sources</h2>
          ...
          <ul>
            ...
            <li>"Dreamland Japan: Writings on Modern Manga" by Frederik L. Schodt - Follow-up exploring manga's evolution</li>
            <li>"The Osamu Tezuka Story: A Life in Manga and Anime" by Toshio Ban and Tezuka Productions</li>
