...
const TVHistory: React.FC = () => {
  ...
  const {
    ...
    error: pageError,
    refreshPage,
  } = useWikiPage("/tv/history");

  // Get page contributors
  const { contributors } = usePageContributors("tv-history-page");
  ...
  // Define TOC sections for TV history
  const tocSections: TocSectionProps[] = [
    {
      title: "TV ERAS",
      quickLinks: [
        { label: "Early Television", anchor: "#early-television" },
    ...
    <div className="tv-page">
      <header>
        <div className="image-header">
          <img src="/images/tv/TVHeader.jpg" alt="TV History" />
        </div>

        <WikiSearchBar
          placeholder="Search TV History, Shows, Characters, etc."
      ...
      <main id="main-content">
        ...
        <TableOfContents
          ...
          title="TV History"
          description="The complete timeline and evolution of television."
        />

        {/* Dynamic Wiki Content */}
        {pageLoading ? (
          <div className="section-content loading">
            <h2>📚 Loading TV History...</h2>
