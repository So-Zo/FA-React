  ...
  const tocSections: TocSectionProps[] = [
    {
      ...
      quickLinks: [
        { label: "Popular Shows", anchor: "#popular-shows" },
        { label: "By Genre", anchor: "#browse-by-genre" },
        { label: "By Network", anchor: "#browse-by-network" },
      ],
      deepLinks: [
    ...
    <div className="tv-page">
      <header>
        <div className="image-header">
          <img src="/images/tv/TVHeader.jpg" alt="TV Directory" />
        </div>

        <WikiSearchBar
          placeholder="Search for TV Shows, Characters, Networks, etc."
      ...
      <main id="main-content">
        ...
        <TableOfContents
          ...
          title="TV Directory"
          description="Browse and explore television shows by genre, network, and category."
        />

        {/* Dynamic Wiki Content */}
        {pageLoading ? (
          <div className="section-content loading">
            <h2>📚 Loading TV Directory...</h2>
