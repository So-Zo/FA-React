          ...
          <main id="main-content">
            ...
            {pageLoading || sectionsLoading ? (
              ...
              >
                <p>
                  <strong>
                    The /anime page doesn't exist in the wiki_pages table yet.
                  </strong>
                </p>
                <p>
                  To create it, run the SQL migration in Supabase:
                  <br />
                  <code>migrations/002_populate_anime_sections.sql</code>
                </p>
              </WikiContentState>
            ) : (
              <>
