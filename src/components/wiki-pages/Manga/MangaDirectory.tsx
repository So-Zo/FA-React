...
const MangaDirectory: React.FC = () => {
  ...
  const {
    ...
    error: pageError,
    refreshPage,
  } = useWikiPage("/manga/directory");

  // Get page contributors
  const { contributors } = usePageContributors("manga-directory-page");
  ...
  // Define TOC sections for manga directory
    ...
    <div className="manga-page">
      <header>
        <div className="image-header">
          <img src="/images/manga/MangaHeader.jpg" alt="Manga Directory" />
        </div>

        <WikiSearchBar
          placeholder="Search for Manga, Characters, Publishers, etc."
      ...
      <main id="main-content">
        ...
        <TableOfContents
          ...
          description="Browse and explore manga by genre, publisher, and category."
        />

        {/* Dynamic Wiki Content */}
        {pageLoading ? (
          <div className="section-content loading">
            <h2>📚 Loading Manga Directory...</h2>
