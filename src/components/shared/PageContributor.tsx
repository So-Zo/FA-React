  ...
  return (
    <footer className={`contributor-footer ${className}`}>
      <div className="contributor-info">
        <img
          src={lastEditor.users?.avatar_url || "/placeholder-avatar.jpg"}
          alt={`${lastEditor.users?.username || "Unknown User"}'s avatar`}
        ...
        <span>
          ...
          >
            {lastEditor.users?.username || "Unknown User"}
          </a>{" "}
      ...
      {showHistoryLink && (
        <a
          href={historyPath || `#page-history-${pageId}`}
